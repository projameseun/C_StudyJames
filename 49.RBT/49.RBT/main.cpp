...
int main()
{
	...
	MyStr.insert(make_mypair(static_cast<string>("ÀºÁø¼ö"), 0));
	MyStr.insert(make_mypair(static_cast<string>("¹Ú¸¸³É"), 0));
	MyStr.insert(make_mypair(static_cast<string>("±è¹ÎÁö"), 0));
	MyStr.insert(make_mypair(static_cast<string>("ÀÌÅÂÈÆ"), 0));
	MyStr.insert(make_mypair(static_cast<string>("Á¤Áø¸ğ"), 0));
	MyStr.insert(make_mypair(static_cast<string>("ÇÏÀÎÅÂ"), 0));
	MyStr.insert(make_mypair(static_cast<string>("ÀÚµÎ¸²"), 0));
	MyStr.insert(make_mypair(static_cast<string>("¹Ú»óÃ¶"), 0));
